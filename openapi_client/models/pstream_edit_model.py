...
class PstreamEditModel(BaseModel):
    """
    PstreamEditModel
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PstreamEditModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PstreamEditModel:
        """Create an instance of PstreamEditModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PstreamEditModel.parse_obj(obj)

        _obj = PstreamEditModel.parse_obj({
