...
class AuthenticationApi(object):
    ...
    @validate_arguments
    def login(self, login_input : LoginInput, **kwargs) -> UserDetails:  # noqa: E501
    ...
    @validate_arguments
    def login_with_http_info(self, login_input : LoginInput, **kwargs) -> ApiResponse:  # noqa: E501
        """Login into api server. (Run this first)  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UserDetails, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['login_input'] is not None:
            _body_params = _params['login_input']
